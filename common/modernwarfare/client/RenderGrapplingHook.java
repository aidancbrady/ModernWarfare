...
public class RenderGrapplingHook extends Render
{
    public void doRenderFishHook(EntityGrapplingHook entitygrapplinghook, double d, double d1, double d2, float f, float f1)
    {
        ...
        {
            float f9 = ((entitygrapplinghook.owner.prevRotationYaw + (entitygrapplinghook.owner.rotationYaw - entitygrapplinghook.owner.prevRotationYaw) * f1) * (float)Math.PI) / 180F;
            float f10 = ((entitygrapplinghook.owner.prevRotationPitch + (entitygrapplinghook.owner.rotationPitch - entitygrapplinghook.owner.prevRotationPitch) * f1) * (float)Math.PI) / 180F;
            ...
            {
                float f11 = ((entitygrapplinghook.owner.prevRenderYawOffset + (entitygrapplinghook.owner.renderYawOffset - entitygrapplinghook.owner.prevRenderYawOffset) * f1) * (float)Math.PI) / 180F;
